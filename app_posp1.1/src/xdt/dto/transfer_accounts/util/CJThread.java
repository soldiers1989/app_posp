...
Logger log = Logger.getLogger(this.getClass());
	...
	public CJThread(ITotalPayService service, DaifuRequestEntity payRequest, PmsMerchantInfo merchantinfo) {
		super();
	...
	public void run() {
		...
		try {
			Thread.sleep(2000);
			for (int i = 0; i < 30; i++) {
			 map= service.cjQuick(payRequest.getV_mid(), payRequest.getV_batch_no());
			 if(map!=null){
